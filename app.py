...
MODEL_PATH = 'model/mango_effnet.pth'
DISEASE_JSON_PATH = 'mango_disease_info.json'  # JSON file for mango diseases
...
model.to(device)
model.eval()
print("🧠 Mango EfficientNet model loaded.")
...
def send_daily_report():
    if daily_stats["count"] == 0:
        return
    try:
        msg = Message("📊 Daily Click Report - Mango Disease Detection",
